...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=0 python main_nerf.py ../../NGP_Dataset/sedan/ford_focus --workspace ford_focus -O --gui --bound 1.0 --scale 0.6 --bg_radius 128
